...
- 販売した基板のバージョンは、Ver 1.01、Ver 1.10、Ver 2.10の3種類が存在します。
- ファームウェアのバージョンは、Ver 1系基板ではVer 1.10eが最新、Ver 2系基板ではVer 1.10gが最新となっています。
